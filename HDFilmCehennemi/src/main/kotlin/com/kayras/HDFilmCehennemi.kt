...
import org.jsoup.Jsouppackage com.kayracs3
...
class HDFilmCehennemi : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "${mainUrl}/category/nette-ilk-filmler-1/"          to "Nette ilk Filmler",
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        val ratingInt   = document.selectFirst("div.post-info-imdb-rating span")
                            ?.text()
                            ?.substringBefore("(")
                            ?.trim()
                            ?.toDoubleOrNull()
